...
<div class="container rounded bg-white mt-5 mb-5">
   ...
   <form id="product_registration_form" method="POST" action="php_backend_stuff/admin_backend.php?func=addproduct" enctype="multipart/form-data" onsubmit="return(product_register_validation())">
    <div class="row">
